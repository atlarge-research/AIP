...
from data_mining.raw_db_access import (
    calculate_authors_n_citations, get_authors, get_paper_citations,
    get_papers_authors,
)
...
def generate_authors_feature_matrix_dictionary(row_size):
    ...
    for author_id in authors_ids:
        authors_matrix_dict[author_id] = csr_matrix(
            (1, row_size),
            dtype=numpy.float_,
        )
