...
class Publications(models.Model):
    ...
    semantic_scholar_id = models.CharField(unique=True,
                                           max_length=64,
                                           blank=True,
                                           null=True)
...
class Cites(models.Model):
    paper = models.ForeignKey('Publications',
                              on_delete=models.CASCADE,
                              related_name='cites')
    cited_paper = models.ForeignKey('Publications',
                                    on_delete=models.CASCADE,
